namespace Лабораторная_работа_1
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelVersion.Text = "Beta Alpha Test 0.0.0.0.1";
            ...
            labelCopyright.Text = "Авторских прав нету, все бесплатно:D, но не всем(";
            ...
            textBoxDescription.Text = "в Варкрафт Хочу(";
